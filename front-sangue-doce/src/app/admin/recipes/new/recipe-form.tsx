...
import { CoverImageField } from "../../posts/new/cover-image-field";
import { PostContentEditor } from "../../posts/new/post-content-editor";
...
export function RecipeForm({
  ...
  async function save(form: HTMLFormElement, status: PostStatus) {
    ...
    try {
      ...
      setMessage(message);
      toast.success(message);
      router.replace(`/admin/recipes/new?id=${recipe.id}`);
      router.refresh();
    } catch (error) {
