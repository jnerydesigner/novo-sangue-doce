  ...
  return (
    ...
    >
      <article className="mx-auto grid max-w-4xl gap-8 rounded-xl border border-line bg-card p-5 sm:p-8">
        ...
        <Link className="w-fit rounded-lg border border-lineStrong px-4 py-2 text-sm font-semibold text-inkSoft hover:bg-paper2" href={`/admin/recipes/new?id=${recipe.id}`}>
          Voltar para edição
        </Link>
      </article>
    </AdminShell>
